...
def parse_args():
    ...
    # Model
    parser.add_argument('--improved', type=bool, default=False, help='Set to True: A + 2I of GCNConv')
    parser.add_argument('--pooling_ratio', type=float, default=0.8, help='Graph pooling ratio')
